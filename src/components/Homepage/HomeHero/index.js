    ...
    return (
        <Container>
            ...
            <Paragraph>
                ...
                <br/><br/>
                This is where I write my long-form thoughts about development, business, and whatever else piques my interest. For my day-to-day ramblings, be sure to follow me over on <a href="https://twitter.com/kpmdev" target="_blank" rel="noopener">Twitter</a>.
            </Paragraph>
